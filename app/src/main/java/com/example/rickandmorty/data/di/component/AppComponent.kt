...
import com.example.presentation.navigation.NavigationModule
...
@Singleton
@Component(modules = [CharacterModule::class, ViewModelModule::class, ApolloModule::class, NavigationModule::class])
